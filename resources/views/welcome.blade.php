            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="">
                    ...
                    <a href="{{ route('register') }}"
                        class="ml-4 text-muted">Register</a>
                    @endif
                    @endif
                </div>
                @endif
                                    ...
                                    <div class="pl-3">
                                        ...
                                        <p class="text-muted small">
                                            Laravel's robust library of first-party tools and libraries, such as <a
                                                ...
                                                class="text-muted">Forge</a>, <a href="https://vapor.laravel.com"
                                                class="text-muted">Vapor</a>, <a href="https://nova.laravel.com"
                                                class="text-muted">Nova</a>, and <a href="https://envoyer.io"
                                                class="text-muted">Envoyer</a> help you take your projects to the next
