...
@push('styles')
<link rel="stylesheet"
    href="{{asset('dash/vendor/charts/chartist-bundle/chartist.css')}}">
<link rel="stylesheet"
    href="{{asset('dash/vendor/charts/morris-bundle/morris.css')}}">
<link rel="stylesheet"
    href="{{asset('dash/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css')}}">
<link rel="stylesheet"
    href="{{asset('dash/vendor/charts/c3charts/c3.css')}}">
<link rel="stylesheet"
    href="{{asset('dash/vendor/fonts/flag-icon-css/flag-icon.min.css')}}">
@endpush
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="m-r-10"><img
                                                            src="{{asset('dash/images/product-pic.jpg')}}"
                                                            alt="user"
                                                            class="rounded"
                                                            width="45"></div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="m-r-10"><img
                                                            src="{{asset('dash/images/product-pic-2.jpg')}}"
                                                            alt="user"
                                                            class="rounded"
                                                            width="45"></div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="m-r-10"><img
                                                            src="{{asset('dash/images/product-pic-3.jpg')}}"
                                                            alt="user"
                                                            class="rounded"
                                                            width="45"></div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="m-r-10"><img
                                                            src="{{asset('dash/images/product-pic-4.jpg')}}"
                                                            alt="user"
                                                            class="rounded"
                                                            width="45"></div>
                                                </td>
...
@push('scripts')
<!-- chart chartist js -->
<script src="{{asset('dash/vendor/charts/chartist-bundle/chartist.min.js')}}"></script>
<!-- sparkline js -->
<script src="{{asset('dash/vendor/charts/sparkline/jquery.sparkline.js')}}"></script>
<!-- morris js -->
<script src="{{asset('dash/vendor/charts/morris-bundle/raphael.min.js')}}"></script>
<script src="{{asset('dash/vendor/charts/morris-bundle/morris.js')}}"></script>
<!-- chart c3 js -->
<script src="{{asset('dash/vendor/charts/c3charts/c3.min.js')}}"></script>
<script src="{{asset('dash/vendor/charts/c3charts/d3-5.4.0.min.js')}}"></script>
<script src="{{asset('dash/vendor/charts/c3charts/C3chartjs.js')}}"></script>
<script src="{{asset('dash/libs/js/dashboard-ecommerce.js')}}"></script>
@endpush