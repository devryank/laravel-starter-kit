...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                ...
                <div class="collapse navbar-collapse "
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        <li class="nav-item nav-user pt-3">
                            <a href="#"
                               id="change-mode"><i class="fas fa-2x"
                                   id="mode"
                                   data-toggle="tooltip"
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{Request::is('panel/dashboard') ? 'active' : ''}}"
                                   href="{{ route('panel.dashboard.index') }}"><i
                                       class="fa fa-fw fa-tachometer-alt {{Request::is('panel/dashboard') ? 'text-white' : ''}}"></i>Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{Request::is('panel/user') ? 'active' : ''}}"
                                   href="{{ route('panel.user.index') }}"><i
                                       class="fa fa-fw fa-user-circle {{Request::is('panel/user') ? 'text-white' : ''}}"></i>User</a>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link {{$active ? 'active' : ''}}"
                                   ...
                                   aria-controls="submenu-1-1"><i
                                       class="fas fa-fw fa-cog {{$active ? 'text-white' : ''}}"></i>Settings</a>
                                <div id="submenu-1-1"
    ...
    <script src="{{asset('dash/libs/js/darkmode.js')}}"></script>
    @livewireScripts
    @stack('scripts')
